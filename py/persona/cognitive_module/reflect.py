...
class Reflect:
    ...
    def reflect(persona):
        ...
        Output:
          None
        """
        if Reflect.reflection_trigger(persona):
            Reflect.run_reflect(persona)
            Reflect.reset_reflection_counter(persona)
        ...
        if persona.scratch.chatting_end_time:
            ...
            if persona.scratch.curr_time + datetime.timedelta(0, 10) == persona.scratch.chatting_end_time:
                ...
                thought_embedding_pair = (planning_thought, PromptStructure.get_embedding(planning_thought))
                ...
                thought_embedding_pair = (memo_thought, PromptStructure.get_embedding(memo_thought))
    ...
    def reflection_trigger(persona):
        ...
        Output:
          ...
          False otherwise.
        """
        print(persona.scratch.name, "persona.scratch.importance_trigger_curr::",
    ...
    def run_reflect(persona):
        ...
        retrieved = Retrieve.new_retrieve(persona, focal_points)
...
def generate_focal_points(persona, n=3):
    ...
    return LLMManager.run_prompt_focal_pt(persona, statements, n)[0]
...
def generate_insights_and_evidence(persona, nodes, n=5):
    ...
    ret = LLMManager.run_prompt_insight_and_guidance(persona, statements, n)[0]
...
def generate_planning_thought_on_convo(persona, all_utt):
    ...
    return LLMManager.run_prompt_planning_thought_on_convo(persona, all_utt)[0]


def generate_memo_on_convo(persona, all_utt):
    if debug: print("GNS FUNCTION: <generate_memo_on_convo>")
    return LLMManager.run_prompt_memo_on_convo(persona, all_utt)[0]
